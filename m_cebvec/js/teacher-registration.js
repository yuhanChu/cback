    ...
    methods: {
        ...
        submit: function() {
            if (this.schoolFlag == 7) {
                ...
                this.json.work_school = this.schoolTxt;
            }
            if (!this.json.name) {
                layer.open({
